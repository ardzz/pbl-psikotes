                ...
                <div class="card-body p-4">
                    ...
                    <form>
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="exampleInputtext" name="full_name" value="{{ $user->name }}">
                        </div>
                        <div class="mb-4">
                            <label for="exampleInputPassword1" class="form-label fw-semibold">Your Email</label>
                            <input type="email" class="form-control" id="exampleInputtext" name="email" value="{{ $user->email }}">
                        </div>
                        <div class="col-12">
