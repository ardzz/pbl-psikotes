                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mt-4 d-flex justify-content-center">
                                <button class="btn btn-light btn-lg me-2">YA</button>
                                <button class="btn btn-light btn-lg me-2">TIDAK MENJAWAB</button>
                                <button class="btn btn-light btn-lg">TIDAK</button>
                            </div>
                        </div>
                    </div>
                </div>
