...
class AnalyzeExamResult extends EditRecord implements HasForms
{
    ...
    public function mount(int|string $record): void
    {
        ...
        $this->form->fill([
            ...
            'response_to_test' => $this->record->response_to_test,
            'validity_score' => $this->record->validity_score,
            'work_performance' => $this->record->work_performance,
            'adaptability' => $this->record->adaptability,
            'psychological_issue' => $this->record->psychological_issue,
            'destructive_action' => $this->record->destructive_action,
            'moral_integrity' => $this->record->moral_integrity,
            'clinical_profile' => $this->record->clinical_profile,
            'openness' => $this->record->openness,
            'conscientiousness' => $this->record->conscientiousness,
            'extraversion' => $this->record->extraversion,
            'agreeableness' => $this->record->agreeableness,
            'neuroticism' => $this->record->neuroticism,
